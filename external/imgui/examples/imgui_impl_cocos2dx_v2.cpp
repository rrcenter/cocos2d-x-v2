...
static void ImGui_ImplOpenGL2_SetupRenderState(ImDrawData* draw_data, int fb_width, int fb_height, GLuint vertex_array_object)
{
...
#endif
    ImGui_ImplOpenGL2_SetupRenderState(draw_data, fb_width, fb_height, vertex_array_object);
